      ...
      >
        {PROJECTS.map((project) => (
          ...
          >
            ...
            <div className="sm:animate-gpu-spin bg-glow sm:bg-glow absolute top-1/2 left-1/2 -z-1 aspect-square min-h-[170%] min-w-[170%] -translate-x-1/2 -translate-y-1/2 blur-xl" />
